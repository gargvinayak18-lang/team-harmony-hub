...
-- Can user view a given task (assigner/assignee/admin/dept-head/PM in their dept)
...
BEGIN
  ...
  -- Default role: assigned by admin later; give nothing initially unless metadata says so
...
-- Profiles: everyone authenticated can read; admins+HR head can insert/update; user can update own non-role fields
...
-- Assignee can update status; assigner/admin/head can update fully
